...
class BaseModel(Model):
    ...
    class Meta:
        database = psql_db
        db_table = 'Recipes_table_TokenAuth'
        table_alias = 'c'


class Recipes_table_TokenAuth(BaseModel):
...
psql_db.connect()
psql_db.create_tables([Recipes_table_TokenAuth], safe=True)
    ...
    with psql_db.atomic():
        ...
        with psql_db.atomic():
            ...
            for recipe in receipes:
                ...
                Recipes_table_TokenAuth.create(**track)
...
if __name__ == '__main__':
    ...
    insert_data(receipes_data,users)